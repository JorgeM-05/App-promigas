...
public interface EbitdaRepository extends JpaRepository<EbitdaEntity, Integer> {
    public List<EbitdaEntity> findByIdOpportunity(OpportunitiesEntity opportunities);
}
