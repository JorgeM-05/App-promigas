...
public interface UtilityRepository extends JpaRepository<UtilityEntity, Integer> {
    public List<UtilityEntity> findByIdOpportunity(OpportunitiesEntity opportunities);
